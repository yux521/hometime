...
#### レシピ投稿頁<br>
・active_hashを使って、目安時間のリストを作成<br>
 リスト選択にすることで、細かい目安時間の記入をできなくしました<br>
・各項目を１つずつ登録を必須にし、入力漏れがあるとエラーの表示を出すようにしました<br>
・エラーの表記を日本語表記に変更

#### レシピ編集<br>
編集後すぐに変更内容を確認し、再度修正できるように、TOPページではなく、詳細頁に移行するようにしました<br>
