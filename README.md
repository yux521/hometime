...
そんなユーザーのために下記の機能をログインなしにし、
シンプルで、探しやすくしました。
レシピの詳細ページには、ログインしていないのでコメント機能は表示されません。
レシピのみを探して、すぐに料理にとりかかれるようにシンプル機能にしました。
ユーザー登録をしている方も、していない方も、この機能は使えます。
...
### ログイン中のユーザー
ログインしていないユーザーの機能＋下記の機能ができます。
自身のオリジナルレシピの投稿
投稿したレシピ内で、他ユーザーとのコミュニケーションがとれます
時間にゆとりがある時に、自身の作った
...
## 画面遷移図
![画像名](https://github.com/yux521/hometime/blob/master/db8c5ba4bc8d07d972960a6d39b57e66.png)
...
## 今後の実装してみたい機能
 ...
 ・ログイン中のユーザー
 カレンダー<br>　 
 メモ帳　　　　　 料理を作りながら買わないといけないものや、レシピのアイデアが出た時に思いついたらすぐに記入できる<br>　
 家計簿　　　　　主婦の味方
